...
n, e = map(int, input().split())   # number of nodes, number of edges

for i in range(e):
    u, v = input().split()         # read the edge
    graph[u].append(v)
    graph[v].append(u)

start = list(graph.keys())[0]      # choose first entered node as start
...
<img width="562" height="313" alt="image" src="https://github.com/user-attachments/assets/94d8548c-e864-405c-a1d5-a812c7d29543" />
